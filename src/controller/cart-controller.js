...
class CartController {
    ...
    async addItemToCart(req, res) {
        ...
        try {
            const stockRef = admin.firestore().collection('Stock').doc(productId);
    ...
    async addToCartOnline(req, res) {
        const { userId, productId } = req.body; // Only userId and stockId are required
